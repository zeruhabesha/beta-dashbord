...
const OPERATIONS = [
    {
        ...
        path: () => '/healthz',
        fields: [],
        description: 'Check Playbook Service health.'
    },
    {
        id: 'playbook-ready',
        group: 'Service Health',
        ...
        path: () => '/readyz',
        fields: [],
        description: 'Check Playbook Service readiness.'
    },
    {
        id: 'approval-health',
        group: 'Service Health',
        ...
        path: () => '/healthz',
        fields: [],
        description: 'Check Approval Service health.'
    },
    {
        id: 'response-health',
        group: 'Service Health',
        ...
        path: () => '/healthz',
        fields: [],
        description: 'Check Response Service health.'
    },
    {
        id: 'audit-health',
        group: 'Service Health',
        ...
        path: () => '/healthz',
        fields: [],
        description: 'Check Audit Service health.'
    },
    {
        id: 'audit-ready',
        group: 'Service Health',
        ...
        path: () => '/readyz',
        fields: [],
        description: 'Check Audit Service OpenSearch readiness.'
    },
    {
        id: 'hunt-health',
        group: 'Service Health',
        label: 'Threat Hunting Health',
        service: 'hunts',
        method: 'GET',
        path: () => '/healthz',
        fields: [],
        description: 'Check Threat Hunting Service health.'
    },
    {
        id: 'playbook-metrics',
        group: 'Observability',
